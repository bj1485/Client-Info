    ...
    Private Sub btnOpen_Click(sender As Object, e As EventArgs) Handles btnOpen.Click
        Try
            If Not tvDatabase.SelectedNode.Text = strPath Then
                ...
                If File.Exists(strDatabasePath & strNotificationsPath) Then
                    Dim intNotification As Integer
                    ReadNotifications(strNotificationsPath, intNotification)
                    Main.mnuNotification.Text = "Hello"
                    'oolStripButton1.Image = My.Resources.SaveIcon ' Optional
        ...
        '        'If tvDatabase.SelectedNode Is Nothing OrElse tvDatabase.SelectedNode Is tvDatabase.Nodes(0) Then
        '        If Not tvDatabase.SelectedNode.Text = strPath Then
        ...
        '            strDatabasePath = Path.Combine(strPath, tvDatabase.SelectedNode.Text & ".DB")
        '            strDatabaseName = tvDatabase.SelectedNode.Text
        '            My.Computer.Registry.SetValue("HKEY_CURRENT_USER\SOFTWARE\Client Information", "Database Path", strDatabasePath)
        '            My.Computer.Registry.SetValue("HKEY_CURRENT_USER\SOFTWARE\Client Information", "Database", strDatabaseName)
        ...
        '        If Not String.IsNullOrEmpty(strPath) AndAlso Not String.IsNullOrEmpty(strEncryptIVKey) AndAlso Not String.IsNullOrEmpty(strEncryptKey) Then

        '            Main.mnuOpenDatabase.Enabled = True
        '            Main.mnuNewDatabase.Enabled = True
        '            Main.mnuCompany.Enabled = True
        '            Main.mnuNewClient.Enabled = True
        '            Main.mnuCaptureInformation.Enabled = True
        '            Main.EditSearchToolStripMenuItem.Enabled = True
        '            Main.NewTemplateToolStripMenuItem.Enabled = True
        '            Main.ImportCSVToolStripMenuItem.Enabled = True
        '            Main.EditTemplateToolStripMenuItem.Enabled = True
        '            Main.BackupToolStripMenuItem.Enabled = True
        '            Main.mnuChangePassword.Enabled = True
        '        End If
